...
These codes and their data is stored in your server's database so please ensure you have all [dependencies](/docs/vmenuox/1-information#dependencies) installed.
...
<Image src="https://grav.wtf/vmenuox-outfitcfg.webp" alt="Hello" width={500} height={500} />
...
> ```cfg
> start ox_lib
> start oxmysql # You only need to have this line if you use oxmysql and are enabling the sharing system.
